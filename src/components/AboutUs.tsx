      ...
      <div className="container max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            <div className="flex items-start gap-6">
              ...
              <div>
                <h3 className="font-heading text-2xl text-foreground mb-2">Alexandra</h3>
          ...
          >
            <div className="flex items-start gap-6">
              ...
              <div>
                <h3 className="font-heading text-2xl text-foreground mb-2">Sergej</h3>
        ...
        >
          <div className="inline-flex items-center gap-3 bg-accent/10 border border-accent/20 rounded-full px-6 py-3">
            <span className="text-foreground font-medium">Wir duzen – weil wir Partner sind, keine Dienstleister.</span>
          </div>
        </motion.div>
      </div>
    </section>
